import "./GetCusCouponsMaxPrice.css";
...
function GetCusCouponsMaxPrice(): JSX.Element {
    ...
    const myUrl="http://localhost:8080/customer/getCustomerCouponsByMaxPrice/"+maxPrice+"/"+cusId;
    useEffect(()=>{
...
export default GetCusCouponsMaxPrice;
