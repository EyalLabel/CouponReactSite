import UserDetails from "../Components/LoginUpgraded/UserDetails";
import OnlineUser from "../Components/Models/OnlineUser";
...
export function authReducer(currentState: AuthState = new AuthState(), action: AuthAction) : AuthState{
    ...
    switch(action.type){
        ...
        // in case of client want to register to the website (insted of admin makes the registration)
